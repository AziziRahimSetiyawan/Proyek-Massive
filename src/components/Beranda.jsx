import ProfilePicture from "../assets/hai.png";
        ...
        <div className="flex-col">
          ...
          <div className="leading-7 mx-2 px-40 text-2xl font-['Poppins'] text-justify justify-center">
            <p>
              ...
              Setiap Kondisi Kritis. Dengan Teknologi Canggih dan Layanan 24/7,
              Kami Siap Membantu Anda di Setiap Detiknya. Panggilan Darurat yang
              Cepat dan Efisien, Karena Kami Percaya Setiap Detik Memiliki Arti
              Penting.
            </p>
          </div>
        </div>
